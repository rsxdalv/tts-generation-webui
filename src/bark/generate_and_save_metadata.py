...
def generate_and_save_metadata(prompt: str, language: Optional[str], speaker_id: Optional[int], text_temp: float, waveform_temp: float,
                               seed: int, filename: str, date: str, filename_png: str, filename_json: str,
                               history_prompt_npz: Optional[str], filename_npz: str, history_prompt: str, history_hash: str):
